...
let usuarioCorrecto = prompt ("Ingrese su nombre de usuario")
let contraseñaCorrecta = prompt ("Ingrese su contraseña")
...
//Este codigo es para el register
let bandera = true
while (bandera) {
    if (usuarioCorrecto === nombreUsuario && contraseñaCorrecta === pass){
        ...
        let deseaReintentar = confirm("Usuario o contraseña incorrecta ¿Desea intentarlo nuevamente?")
        if(deseaReintentar) {
            usuarioCorrecto = prompt ("Ingrese su nombre de usuario")
            contraseñaCorrecta = prompt ("Ingrese su contraseña")
        } else {
            bandera = false
        }
    }
